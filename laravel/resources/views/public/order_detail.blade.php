    ...
    <div
        ...
        <div class="bg-white rounded-2xl shadow-xl p-2 sm:p-10 w-full max-w-5xl mx-auto">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl sm:text-3xl font-extrabold text-pink-600 tracking-tight mb-1 mt-2 flex items-center justify-center gap-2"
                    style="color:#f25270">
                    <i class="bi bi-flower1 text-pink-400 text-2xl" style="color:#f25270"></i> Fellie Florist
                </h1>
                ...
                <div class="mt-2 mb-4">
                    ...
                    <span class="font-mono font-bold text-lg text-pink-600 bg-pink-50 px-3 py-1 rounded-lg border"
                        style="color:#f25270">{{ $order->public_code }}</span>
                    <br>
                    ...
                    <br>
                        ...
                        @endphp
                        <span class="text-xs text-gray-500">No. Urut: </span>
                        <span class="font-mono font-semibold text-sm text-pink-700 bg-pink-50 px-3 py-1 rounded-lg border">{{ $customOrderNumber }}</span>
                </div>
            </div>
            <!-- Status Badge -->
                    ...
                    <div class="flex-1 min-w-0 max-w-full flex flex-col justify-center items-center">
                        <div
                            ...
                            <div class="text-xs sm:text-sm text-gray-700 leading-relaxed text-center break-words">
                                {{ $order->info ?? 'Semua pesanan diproses berdasarkan nomor urut.
Pesanan dengan nomor urut lebih awal akan diprioritaskan terlebih dahulu.
Waktu pengerjaan dapat berbeda tergantung jenis dan jumlah pesanan yang masuk.
Mohon kesabaran dan pengertian Anda, Dan jika ada pertanyaan silahkan hubungi kami.😊🙏' }}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="w-full flex justify-center mt-4 mb-4">
        <a href="{{ route('public.flowers') }}"
            class="inline-flex items-center gap-2 bg-pink-500 hover:bg-pink-600 text-white font-bold px-4 py-2 rounded-lg shadow transition" style="background:#f25270">
