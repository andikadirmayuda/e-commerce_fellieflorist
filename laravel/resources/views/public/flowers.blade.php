...
<head>
    ...
    <style>
        ...
        .promo-label {
            ...
            background: linear-gradient(135deg, #f25270, #f285a2);
            color: #ffffff;
            font-weight: bold;
            padding: 5px 40px;
            transform: rotate(-45deg);
            box-shadow: 0 2px 5px #f25270;
            font-size: 14px;
...
<body class="min-h-screen gradient-bg text-black flex flex-col font-sans overflow-x-hidden">
            ...
            <div class="flex flex-col items-center">
                <div class="mb-3">
                    <svg width="60" height="60" fill="none" viewBox="0 0 60 60">
                        <circle cx="30" cy="30" r="30" fill="#f285a2" opacity="0.1" />
                        <path d="M30 16v20M30 44h.02" stroke="#f285a2" stroke-width="3" stroke-linecap="round" />
                    </svg>
                </div>
                <h2 class="text-lg font-bold mb-2 text-center">Cara Memesan di Fellie Florist</h2>
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('public.flowers') }}" class="flex items-center">
                            <div>
                                ...
                                <p class="text-[7px] sm:text-xs text-gray-500">Supllier Bunga Palembang</p>
                            </div>
                        </a>
                    </div>
                    ...
                    <nav class="flex items-center justify-center">
                        <div class="flex items-center justify-center space-x-2 sm:space-x-4 md:space-x-8">
                            <a href="{{ route('public.flowers') }}"
                                class="px-2 sm:px-4 py-1.5 text-center {{ $activeTab === 'flowers' ? 'bg-[#f25270] text-white rounded-xl' : 'text-[#f285a2] hover:bg-[#f285a2]/10' }}">
                                <span
                            ...
                            <a href="{{ route('public.bouquets') }}"
                                class="px-2 sm:px-4 py-1.5 text-center {{ $activeTab === 'bouquets' ? 'nav-tab nav-hover-effect group relative items-center space-x-2 px-3 py-2 rounded-xl transition-all duration-300 bg-gradient-to-r from-[#f285a2] to-[#f25270] shadow-lg nav-active-gradient' : 'text-[#f2527d] hover:bg-[#f285a2]/10' }}">
                                <span
                                    class="text-sm font-medium {{ $activeTab === 'bouquets' ? 'text-white' : '' }}">BOUQUET</span>
                            </a>

                            <a href="{{ route('custom.bouquet.create') }}"
                                class="px-2 sm:px-4 py-1.5 text-center text-[#f2527d] hover:bg-[#f285a2]/10 rounded-xl transition-all duration-300">
    ...
    <div class="w-full max-w-6xl mx-auto px-4 py-6">
        ...
        <div class="mb-8 flex flex-col items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <div class="flex-1 relative">
                        ...
                        <input type="text" id="searchInput"
                            ...
                            class="w-full pl-12 pr-4 py-4 text-lg border-2 border-[#f25270] rounded-2xl focus:ring-2 focus:ring-[#172124] focus:border-[#172124] focus:outline-none shadow-lg transition-all duration-200 bg-white/90"
                            oninput="filterItems()">
                    </div>
                    ...
                    @if($activeTab === 'flowers')
                        <div class="relative">
                            <select id="priceFilterSelect"
                                class="appearance-none bg-white/90 border-2 border-[#f25270] rounded-2xl px-4 py-4 pr-10 text-gray-700 focus:ring-2 focus:ring-[#172124] focus:border-[#172124] focus:outline-none shadow-lg transition-all duration-200 cursor-pointer"
            ...
            <div class="flex flex-wrap gap-3 justify-center mb-4">
                <button type="button"
                    class="chip-btn px-6 py-3 rounded-full border-2 border-[#f25270] bg-white text-[#f25270] text-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#172124]/10 transition-all duration-200 active"
                    data-category="" onclick="selectCategory(this)">
                    <span class="mr-2"></span>Semua
                </button>
                @foreach($flowerCategories as $category)
                <button type="button"
                    class="chip-btn px-6 py-3 rounded-full border-2 border-[#f25270] bg-white text-[#f25270] text-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#fffffff]/10 transition-all duration-200"
            ...
            <div class="flex flex-wrap gap-3 justify-center mb-4">
                <button type="button"
                    class="chip-btn px-6 py-3 rounded-full border-2 border-[#f285a2] bg-white text-[#f285a2] text-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#f285a2]/10 transition-all duration-200 active"
                    data-category="" onclick="selectCategory(this)">
                    <span class="mr-2">🌸</span>Semua
                </button>
                @foreach($flowerCategories as $category)
                <button type="button"
                    class="chip-btn px-6 py-3 rounded-full border-2 border-[#f285a2] bg-white text-[#f285a2] text-sm font-semibold shadow-md hover:shadow-lg hover:bg-[#f285a2]/10 transition-all duration-200"
                    data-category="{{ $category->name }}" onclick="selectCategory(this)">
                    <span class="mr-2">🌿</span>{{ $category->name }}
                </button>
                @endforeach
                            ...
                            <div class="relative h-48 md:h-80 sm:h-40 mb-3 sm:mb-4 rounded-xl overflow-hidden">
                                ...
                                @else
                                    <div
                                        ...
                                        {{-- <i class="bi bi-flower1 text-3xl text-[#f25270]">🌸</i> --}}
                                    ...
                                    <div class="grosir-label">
                                        <svg class="grosir-label-svg" viewBox="0 0 120 40" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#f25270" stroke="#E59420" stroke-width="3" />
                                        </svg>
                                ...
                                <div class="absolute top-2 sm:top-3 right-2 sm:right-3 flex gap-2 z-30">
                                    ...
                                    <button
                                        ...
                                        class="w-6 sm:w-8 h-6 sm:h-8 bg-white/90 hover:bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                        <i class="bi bi-eye text-[#f285a2] text-xs sm:text-sm"></i>
                                    </button>
                                </div>
                            </div>
        ...
        $baseUnit = $flower->base_unit ?? 'tangkai';
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-1.5">
                                        <div class="bg-gradient-to-r from-[#f285a2] to-[#f25270] h-1.5 rounded-full transition-all duration-300"
                                ...
                                <button onclick="{{ $isOut ? 'return false' : 'handleAddToCart(' . (int) $flower->id . ')' }}"
                                    class="mt-auto w-full {{ $isOut ? 'bg-gray-300 text-gray-600 cursor-not-allowed' : 'bg-gradient-to-r from-[#f2527d] to-[#f25270] hover:from-[#f25270] hover:to-[#f25270] text-white shadow-md hover:shadow-lg' }} font-semibold py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl transition-all duration-200 text-xs sm:text-sm"
                                    {{ $isOut ? 'disabled' : '' }}>
                                    @if($isOut)
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="flex flex-wrap gap-1 justify-start">
                                        @foreach($bouquet->sizes as $size)
                                            <span
                                                class="inline-block px-2 py-1 bg-gradient-to-r from-[#f25270]/10 to-[#172124]/10 text-[#f25270] rounded-full text-[10px] sm:text-xs font-medium">
                                                {{ $size->name }}
                                            </span>
                                        @endforeach
                                    </div>
        ...
        $maxPrice = $bouquet->prices->max('price');
                                ...
                                <a href="{{ route('public.bouquet.detail', $bouquet->id) }}"
                                    class="mt-auto w-full bg-gradient-to-r from-[#f25270] to-[#172124] hover:from-[#f25270] hover:to-[#f25270] text-white font-semibold py-1.5 sm:py-2 px-3 sm:px-4 rounded-xl transition-all duration-200 shadow-md hover:shadow-lg text-xs sm:text-sm text-center block">
        ...
        @if($activeTab === 'flowers')
            <div class="mt-16 text-center">
                <div
                    class="bg-gradient-to-br from-[#f25270]/20 via-white to-[#f25270]/20 rounded-3xl p-8 shadow-lg border border-[#f25270]/20">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#f25270] to-[#f25270] rounded-full mb-6 shadow-lg">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <a href="{{ route('public.bouquets') }}"
                            class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-[#f285a2] to-[#f25270] hover:from-[#666666] hover:to-[#f285a2] text-white font-semibold rounded-xl transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
    ...
    <footer class="bg-gradient-to-r from-[#f2527d] to-[#f25270] text-white py-12 mt-16">
        <div class="max-w-6xl mx-auto px-4 text-center">
            ...
            <p class="text-white mb-4 max-w-2xl mx-auto">
                Fellie Florist | Supplier Bunga Palembang, Menghadirkan bunga segar berkualitas, buket bunga indah,
                karangan bunga
                elegan, hingga layanan custom rangkaian bunga dan pengiriman ke seluruh Kota Palembang dan sekitarnya.
            </p>
            <div class="flex justify-center space-x-6 mb-6">
                ...
                <a href="https://wa.me/6282177929879?text=Halo%20Fellie%20Florist%20!"
                    class="text-white hover:text-white transition-colors" target="_blank" rel="noopener noreferrer">
                    <i class="bi bi-whatsapp text-xl"></i>
                </a>
            </div>
            <p class="text-white text-sm">© 2025 Fellie Florist. All rights reserved.</p>
            <br>
            <br>
    ...
    <button id="scrollToBottomBtn" title="Scroll ke bawah"
        class="fixed top-1/2 right-6 -translate-y-1/2 z-50 bg-[#f25270] text-white rounded-full shadow-lg p-3 flex items-center justify-center transition-all duration-300 opacity-0 pointer-events-none hover:bg-[#f285a2] hover:text-black focus:outline-none"
    ...
    <script>
        ...
        function selectCategory(btn) {
            ...
            document.querySelectorAll('.chip-btn').forEach(button => {
                button.classList.remove('bg-[#f25270]', 'text-white', 'border-[#f25270]');
                button.classList.add('bg-white', 'text-gray-700', 'border-[#f25270]');
            });
            btn.classList.add('bg-[#f25270]', 'text-white', 'border-[#f25270]');
            btn.classList.remove('bg-white', 'text-gray-700', 'border-[#f25270]');
            filterItems();
        }
