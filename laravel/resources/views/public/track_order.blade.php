                                        ...
                                        <div class="flex-1 space-y-4">
                                            ...
                                            @if($order->voucher_code)
                                                <div class="mt-3 bg-rose-50 rounded-lg p-3">
                                                    <div class="flex items-start gap-2">
                                                        <i class="bi bi-ticket-perforated text-rose-400 mt-0.5"></i>
                                                        <div>
                                                            <p class="text-sm font-medium text-rose-700">Voucher:</p>
                                                            <div class="flex items-center gap-2 mt-1">
                                                                <span
                                                                    class="text-sm font-semibold text-rose-600">{{ $order->voucher_code }}</span>
                                                            ...
                                                            @if($order->voucher_description)
                                                                <p class="text-xs text-rose-600 mt-1">{{ $order->voucher_description }}</p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="mt-16">
            <div class="bg-white rounded-xl shadow-lg p-8 card-hover">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        <div class="inline-flex items-center justify-center w-12 h-12 bg-rose-100 rounded-full mb-4">
                            <i class="bi bi-envelope text-rose-600 text-xl"></i>
                        </div>
