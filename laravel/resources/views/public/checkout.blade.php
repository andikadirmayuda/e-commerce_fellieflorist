...
<body class="min-h-screen gradient-bg font-sans">
    ...
    <header class="w-full glass-effect border-b border-gray-100 sticky top-0 z-40">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex items-center justify-between h-20 md:h-24 pl-7 mt-2">
                <!-- Brand Section -->
                <div class="flex items-center space-x-3">
                    <a href="{{ route('public.flowers') }}" class="flex items-center space-x-3">
                        <div
                            class="w-10 h-10 bg-white scale-90 rounded-full shadow-lg flex items-center justify-center">
                            <img src="{{ asset('logo-fellie-florist.png') }}" alt="Logo" class="rounded-full w-9 h-9">
                        </div>
                        <div>
                ...
                <div class="flex items-center space-x-4">
                    <a href="{{ route('public.flowers') }}"
                        class="text-white bg-gradient-to-br from-[#172124] to-[#f25270] p-2 rounded-lg hover:bg-[#172124] shadow-lg transition-all duration-200"
        ...
        <div class="text-center mb-8 form-enter">
            ...
            <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">
                Checkout <span class="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-pink-600"
                    style="color: #f25270;">Pesanan</span>
            </h1>
            ...
            foreach ($cartRaw as $key => $item) {
                if (isset($item['type']) && $item['type'] === 'custom_bouquet') {
                    ...
                    break;
                                ...
                                <!-- Submit Button -->
                                <button type="submit"
                                    class="w-full mt-6 bg-gradient-to-r from-[#f25270] via[#ca79a1ff] to-[#172124] hover:from-[#172124] hover:to-[#f25270] text-white font-bold py-4 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl card-hover">
                                    {{-- class="w-full mt-6 bg-rose-500 text-white font-bold rounded-xl py-4 transition-all
                                    duration-200
