        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center">
                <div class="flex items-center justify-center w-10 h-10 bg-pink-100 rounded-xl mr-3">
                    <i class="bi bi-plus-circle text-pink-600 text-xl"></i>
                </div>
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Transaksi Cash Flow</h1>
                    <p class="text-sm text-gray-500 mt-1">Input pemasukan atau pengeluaran kas toko</p>
                </div>
            </div>
                ...
                <form action="{{ route('cashflow.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description"
                            class="px-3 py-2 bg-white border border-gray-200 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all text-sm"></textarea>
                    </div>
                    <div class="flex gap-2">
                        <button
                            ...
                            type="submit">
                            <i class="bi bi-save mr-1.5"></i> Simpan
                        </button>
                        <a href="{{ route('cashflow.index') }}"
