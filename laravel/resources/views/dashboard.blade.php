                        ...
                        <form method="GET" action="{{ url('dashboard') }}"
                            ...
                            <div class="flex flex-col gap-2 w-full md:w-auto">
                                <div class="flex gap-4 items-center">
                                    ...
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-2 text-sm font-semibold text-pink-700">Rentang Tanggal</span>
                                    </label>
                                </div>
                                <div class="text-xs text-gray-500 mt-1">Pilih mode filter: berdasarkan bulan/tahun atau
                            ...
                            <div class="flex flex-wrap gap-4 w-full md:w-auto">
                                ...
                                <div id="range_group" class="flex gap-2 items-end">
                                    <div>
                                        <label for="start_date" class="block text-xs font-semibold text-gray-600 mb-1">Dari
                                            Tanggal</label>
                                    ...
                                    <div>
                                        <label for="end_date" class="block text-xs font-semibold text-gray-600 mb-1">Sampai
                                            Tanggal</label>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-600 mb-2">
                                    Link ini dapat dibagikan kepada pelanggan untuk melihat produk ready stock tanpa
                                    perlu
                                    login:
                                </p>
                                <a href="{{ url('/product-fellieflorist') }}" target="_blank"
