...
Route::get('/product-fellieflorist', [PublicFlowerController::class, 'index'])->name('public.flowers');
Route::get('/bouquet-fellieflorist', [PublicBouquetController::class, 'index'])->name('public.bouquets');
