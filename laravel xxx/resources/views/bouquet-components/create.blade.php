                                                    ...
                                                    <div class="grid grid-cols-2 gap-2" id="bouquetsGrid">
                                                        @foreach($bouquets as $bouquet)
                                                            <button type="button"
                                                                ...
                                                                data-category="{{ $bouquet->category_id }}"
                                                                data-name="{{ strtolower($bouquet->name) }}"
                                                                data-original-name="{{ $bouquet->name }}">
                                                                {{ $bouquet->name }}
                                                                <span
                                                                    class="text-xs bg-[#666666] text-white px-2 py-1 rounded-lg ml-2"
                                                                    style="color:[#666666]">
                                                                ...
                                                                <button type="button"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        @if($product->current_stock > 0)
                                                                            <span
                                                                                class="text-xs text-white">({{ $product->current_stock }})</span>
                                                                        @else
                                                                            <span
                                                                                class="text-xs font-semibold text-red-600 bg-red-100 rounded px-2 py-0.5">Habis
                                                                            </span>
                                                                        @endif
                                                                    </span>
                                                                </button>
