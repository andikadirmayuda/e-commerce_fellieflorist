...
<head>
    ...
    <meta property="og:image" content="{{ asset('logo-fellie-florist.png') }}">
        ...
        <div class="print-container bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div
                ...
                <div class="flex justify-center mb-4">
                    <img src="{{ asset('logo-fellie-florist.png') }}" alt="Fellie Florist Logo"
                ...
                <div class="text-sm text-gray-600 leading-relaxed">
                    <p>Jl. Lunjuk Jaya No.5, Bukit Lama, Kec. Ilir Bar. I, Kota Palembang</p>
                    <p class="mt-2">
                        <i class="bi bi-whatsapp mr-1"></i>0821-7792-9879 |
