...
<div id="sideCart"
    ...
    <div class="h-full flex flex-col">
        <!-- Cart Header -->
        <div
            class="p-4 border-b border-gray-200 flex items-center justify-between bg-gradient-to-r from-[#172124] to-[#f25270]">
            <h3 class="text-lg font-bold text-white flex items-center">
                <i class="bi bi-bag mr-2"></i> Keranjang Belanja
            </h3>
            <button onclick="toggleCart()" class="text-white text-lg font-bold hover:text-gray-700">
        ...
        <div class="border-t border-gray-200 p-4 bg-white">
            <div class="flex justify-between mb-4">
                ...
                <span class="font-bold text-rose-600" style="color: #f25270;" id="cartTotal">Rp 0</span>
            </div>
            <a href="{{ route('public.checkout') }}"
                class="block w-full bg-gradient-to-r from-[#f25270] to-[#172124] text-white text-center py-3 rounded-xl font-semibold hover:from-rose-600 hover:to-pink-600 transition-all shadow-lg duration-200">
                Lanjut ke Checkout
            </a>
        </div>
    </div>
