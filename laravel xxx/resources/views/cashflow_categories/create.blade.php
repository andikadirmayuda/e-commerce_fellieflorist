    ...
    <x-slot name="header">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Tambah Kategori Cash Flow</h1>
                    <p class="text-sm text-gray-500 mt-1">Input nama kategori pemasukan/pengeluaran kas</p>
                </div>
            </div>
    ...
    <div class="py-8 gradient-bg min-h-screen">
        <div class="max-w-xl mx-auto">
            <div class="section-card p-8">
                <form action="{{ route('cashflow-categories.store') }}" method="POST" class="space-y-5">
                    @csrf
                    <div>
